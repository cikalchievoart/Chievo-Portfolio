        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredSkills.map((skill, idx) => (
            <div
              ...
              className="group relative rounded-2xl p-[1px] bg-gradient-to-b from-slate-200 via-slate-100 to-transparent dark:from-white/10 dark:via-white/5 dark:to-transparent hover:from-cyan-500/40 hover:to-indigo-500/20 transition-all duration-500 shadow-sm dark:shadow-md spotlight-card border border-slate-200/80 dark:border-transparent"
            >
